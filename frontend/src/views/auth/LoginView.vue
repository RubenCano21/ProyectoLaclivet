...
<template>
  ...
  <div class="min-h-screen flex items-stretch font-['DM_Sans',sans-serif]">
    ...
    <!-- ══ Panel izquierdo ══ -->
    <div 
      class="hidden lg:flex lg:w-[55%] relative flex-col overflow-hidden
      ...
      <div class="relative z-10 flex flex-col justify-between h-full p-12 text-white">
        ...
        <div class="flex items-center gap-3">
          ...
          <div 
            class="ml-auto flex items-center gap-1.5 text-[.68rem] font-medium
        ...
        <div class="flex flex-col items-center text-center gap-7">
          ...
          <div class="relative w-52 h-52 animate-[heroIn_1s_ease_both]">
            <img 
              src="@/assets/images/perrolab.jpeg" alt="Laboratorio clínico veterinario" class="w-full h-full rounded-full object-cover object-center
            ...
            <span 
              class="absolute -inset-6 rounded-full border border-dashed border-white/[.07]
    ...
    <div 
      ...
      <!-- Tarjeta -->
      <div 
        class="relative z-10 w-full max-w-105 bg-white rounded-[1.6rem] p-8 sm:p-10
        ...
        <div class="mb-7">
          ...
          <h1 
            class="font-['Playfair_Display',serif] text-[1.9rem] font-extrabold
        ...
        <form class="space-y-5" @submit.prevent="handleLogin" >
            ...
            <div class="relative group">
              ...
              <input
                ...
                autocomplete="current-password" required placeholder="••••••••" class="w-full rounded-[.875rem] border-[1.5px] border-mineral-green-200
                       ...
                       focus:shadow-[0_0_18px_rgba(74,222,128,.14)]" />
              <button 
                type="button" class="absolute inset-y-0 right-0 flex items-center pr-3.5
          ...
          <transition name="fade">
            <div 
              v-if="auth.error" class="flex items-start gap-2.5 rounded-[.875rem]
          ...
          <!-- Botón submit -->
          <button 
            type="submit" :disabled="auth.loading" class="relative overflow-hidden mt-1
            ...
            <!-- Shimmer sweep -->
            <span 
              class="absolute top-0 -left-full bottom-0 w-3/5 pointer-events-none
                         skew-x-[-20deg]
        ...
        <p class="mt-4 text-center text-[.8rem] text-mineral-green-600">
          ...
          <router-link :to="{ name: 'registro' }" class="font-semibold text-mineral-green-800 hover:underline">
            Regístrate
          </router-link>
    </p>
      </div>
